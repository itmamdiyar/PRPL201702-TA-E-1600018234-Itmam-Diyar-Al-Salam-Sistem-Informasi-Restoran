 <?php
 session_start();
 $koneksi = new mysqli("localhost","root","","Sistem_Informasi_Restoran");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">IT Resto</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;">  &nbsp; 
<a href="homepage.html" class="btn btn-success square-btn-adjust">Go To Website</a>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=booking"><i class="fa fa-dashboard fa-3x"></i> Booking Tempat</a></li>
                    <li><a href="index.php?halaman=contact"><i class="fa fa-dashboard fa-3x"></i> Contact</a></li>
